 ...
 * 
 *  $Id: AUF.java 6044 2010-02-01 15:18:50Z rgw_ch $
 *******************************************************************************/
...
public class AUF extends PersistentObject {
	...
	public AUF(Fall f, String von, String bis, String proz, String grund){
		if (f != null) {
			...
			if (p != null) {
				...
				}, p.getId(), f.getId(), von, bis, proz, grund, new TimeTool()
	...
	public String getLabel(){
		...
		sb.append(v[0]).append("-").append(v[1]).append(": ").append(v[2]).append("% (").append(
			v[3]).append(")");
		return sb.toString();
	}
