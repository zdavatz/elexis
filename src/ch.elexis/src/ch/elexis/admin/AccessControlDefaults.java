...
public class AccessControlDefaults {
	...
	public static final ACE ACCOUNTING_STATS = new ACE(ACCOUNTING,
	...
	public static final ACE ACCOUNTING_GLOBAL = new ACE(
			ACE.ACE_ROOT,
	...
	public static final ACE ACCOUNTING_BILLCREATE = new ACE(
			ACCOUNTING_GLOBAL,
			"createBills", Messages.getString("AccessControlDefaults.createBills")); //$NON-NLS-1$ //$NON-NLS-2$
	public static final ACE ACCOUNTING_BILLMODIFY = new ACE(
			ACCOUNTING_GLOBAL,
			"modifyBills", Messages.getString("AccessControlDefaults.modifyBills")); //$NON-NLS-1$ //$NON-NLS-2$
	public static final ACE ADMIN_ACE = new ACE(ADMIN, "ACE",
			"ACE modifizieren");

	public static final ACE ACL_USERS = new ACE(
			ACE_ACCESS,
	...
	public static final ACE DELETE_BILLS = new ACE(DELETE,
			"Rechnungen", Messages.getString("AccessControlDefaults.bills")); //$NON-NLS-1$ //$NON-NLS-2$
	public static final ACE DELETE_MEDICATION = new ACE(
			DELETE,
	...
	public static final ACE KONTAKT_DELETE = new ACE(DELETE,
			"Kontakt", Messages.getString("AccessControlDefaults.contact")); //$NON-NLS-1$ //$NON-NLS-2$
	public static final ACE KONTAKT_ETIKETTE = new ACE(
			KONTAKT,
			"etikettieren", Messages.getString("AccessControlDefaults.modifySticker")); //$NON-NLS-1$ //$NON-NLS-2$

	public static final ACE PATIENT = new ACE(
			DATA,
			"Patient", Plafs.get(Messages.getString("AccessControlDefaults.main_Patient"))); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public static final ACE LSTG_CHARGE_FOR_ALL = new ACE(LEISTUNGEN,
			"AlleVerrechnen",
			Messages.getString("AccessControlDefaults.chargeAll"));

	public static final ACE KONS = new ACE(
			ACE.ACE_ROOT,
			"Konsultation", Plafs.get(Messages.getString("AccessControlDefaults.main_consultation"))); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public static final ACE KONS_DELETE = new ACE(
			DELETE,
	...
	public static final ACE CASE = new ACE(
			ACE.ACE_ROOT,
			"Fall", Plafs.get(Messages.getString("AccessControlDefaults.main_case"))); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public static final ACE ADMIN_KONS = new ACE(
			ADMIN,
			"Konsultation", Plafs.get(Messages.getString("AccessControlDefaults.main_consultation"))); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public static final ACE ADMIN_KONS_EDIT_IF_BILLED = new ACE(
			ADMIN_KONS,
	...
	public static final ACE ADMIN_CHANGE_BILLSTATUS_MANUALLY = new ACE(
			ADMIN_BILLS,
	...
	public static final ACE DOCUMENT_CREATE = new ACE(DOCUMENT,
			"Erstellen", Messages.getString("AccessControlDefaults.create")); //$NON-NLS-1$ //$NON-NLS-2$
	public static final ACE DOCUMENT_TEMPLATE = new ACE(
			DOCUMENT,
			"Vorlagen ändern", Messages.getString("AccessControlDefaults.changeTemplates")); //$NON-NLS-1$ //$NON-NLS-2$
	public static final ACE DOCUMENT_SYSTEMPLATE = new ACE(
			DOCUMENT,
	...
	public static final ACE ACE_DOC_CREATE = new ACE(ACE_DOCUMENTS,
			"Erstellen",
	...
	public static final ACE ACE_DOC_CATCREATE = new ACE(ACE_DOCUMENTS,
			"KatErstellen",
			Messages.getString("AccessControlDefaults.documentsCreateCat"));
	public static final ACE ACE_DOC_CATDELETE = new ACE(ACE_DOCUMENTS,
			"KatLoeschen",
	...
	private static final ACE[] Anwender = { DATA, ACTIONS, DOCUMENT, KONS,
