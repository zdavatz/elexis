...
public abstract class AbstractDocument implements IDocument {
  ...
  private class DocumentListener implements IDocumentListener {
    ...
    public void onNew(IDocumentEvent documentEvent) {
      if(documentListenerList != null) {
        for(int i=0, n=documentListenerList.size(); i<n; i++) {
          try {
            ((IDocumentListener)documentListenerList.get(i)).onNew(documentEvent);
          }
    ...
    public void onLoad(IDocumentEvent documentEvent) {
      if(documentListenerList != null) {
        for(int i=0, n=documentListenerList.size(); i<n; i++) {
          try {
            ((IDocumentListener)documentListenerList.get(i)).onLoad(documentEvent);
          }
          catch(java.lang.Exception exception) {
            //do not consume
          }
    ...
    public void onLoadDone(IDocumentEvent documentEvent) {
      if(documentListenerList != null) {
        for(int i=0, n=documentListenerList.size(); i<n; i++) {
          try {
            ((IDocumentListener)documentListenerList.get(i)).onLoadDone(documentEvent);
          }
          catch(java.lang.Exception exception) {
            //do not consume
          }
    ...
    public void onLoadFinished(IDocumentEvent documentEvent) {
      if(documentListenerList != null) {
        for(int i=0, n=documentListenerList.size(); i<n; i++) {
          try {
            ((IDocumentListener)documentListenerList.get(i)).onLoadFinished(documentEvent);
          }
          catch(java.lang.Exception exception) {
            //do not consume
          }
    ...
    public void onSave(IDocumentEvent documentEvent) {
      if(documentListenerList != null) {
        for(int i=0, n=documentListenerList.size(); i<n; i++) {
          try {
            ((IDocumentListener)documentListenerList.get(i)).onSave(documentEvent);
          }
          catch(java.lang.Exception exception) {
            //do not consume
          }
    ...
    public void onSaveDone(IDocumentEvent documentEvent) {
      if(documentListenerList != null) {
        for(int i=0, n=documentListenerList.size(); i<n; i++) {
          try {
            ((IDocumentListener)documentListenerList.get(i)).onSaveDone(documentEvent);
          }
          catch(java.lang.Exception exception) {
            //do not consume
          }
    ...
    public void onSaveFinished(IDocumentEvent documentEvent) {
      if(documentListenerList != null) {
        for(int i=0, n=documentListenerList.size(); i<n; i++) {
          try {
            ((IDocumentListener)documentListenerList.get(i)).onSaveFinished(documentEvent);
          }
          catch(java.lang.Exception exception) {
            //do not consume
          }
    ...
    public void onSaveAs(IDocumentEvent documentEvent) {
      if(documentListenerList != null) {
        for(int i=0, n=documentListenerList.size(); i<n; i++) {
          try {
            ((IDocumentListener)documentListenerList.get(i)).onSaveAs(documentEvent);
          }
          catch(java.lang.Exception exception) {
            //do not consume
          }
    ...
    public void onSaveAsDone(IDocumentEvent documentEvent) {
      if(documentListenerList != null) {
        for(int i=0, n=documentListenerList.size(); i<n; i++) {
          try {
            ((IDocumentListener)documentListenerList.get(i)).onSaveAsDone(documentEvent);
          }
          catch(java.lang.Exception exception) {
            //do not consume
          }
    ...
    public void onModifyChanged(IDocumentEvent documentEvent) {
      ...
      if(documentListenerList != null) {
        for(int i=0, n=documentListenerList.size(); i<n; i++) {
          try {
            ((IDocumentListener)documentListenerList.get(i)).onModifyChanged(documentEvent);
          }
          catch(java.lang.Exception exception) {
            //do not consume
          }
    ...
    public void onMouseOver(IDocumentEvent documentEvent) {
      if(documentListenerList != null) {
        for(int i=0, n=documentListenerList.size(); i<n; i++) {
          try {
            ((IDocumentListener)documentListenerList.get(i)).onMouseOver(documentEvent);
          }
          catch(java.lang.Exception exception) {
            //do not consume
          }
    ...
    public void onMouseOut(IDocumentEvent documentEvent) {
      if(documentListenerList != null) {
        for(int i=0, n=documentListenerList.size(); i<n; i++) {
          try {
            ((IDocumentListener)documentListenerList.get(i)).onMouseOut(documentEvent);
          }
          catch(java.lang.Exception exception) {
            //do not consume
          }
    ...
    public void onFocus(IDocumentEvent documentEvent) {
      if(documentListenerList != null) {
        for(int i=0, n=documentListenerList.size(); i<n; i++) {
          try {
            ((IDocumentListener)documentListenerList.get(i)).onFocus(documentEvent);
          }
          catch(java.lang.Exception exception) {
            //do not consume
          }
    ...
    public void onAlphaCharInput(IDocumentEvent documentEvent) {
      if(documentListenerList != null) {
        for(int i=0, n=documentListenerList.size(); i<n; i++) {
          try {
            ((IDocumentListener)documentListenerList.get(i)).onAlphaCharInput(documentEvent);
          }
          catch(java.lang.Exception exception) {
            //do not consume
          }
    ...
    public void onNonAlphaCharInput(IDocumentEvent documentEvent) {
      if(documentListenerList != null) {
        for(int i=0, n=documentListenerList.size(); i<n; i++) {
          try {
            ((IDocumentListener)documentListenerList.get(i)).onNonAlphaCharInput(documentEvent);
          }
          catch(java.lang.Exception exception) {
            //do not consume
          }
    ...
    public void onInsertStart(IDocumentEvent documentEvent) {
      if(documentListenerList != null) {
        for(int i=0, n=documentListenerList.size(); i<n; i++) {
          try {
            ((IDocumentListener)documentListenerList.get(i)).onInsertStart(documentEvent);
          }
          catch(java.lang.Exception exception) {
            //do not consume
          }
    ...
    public void onInsertDone(IDocumentEvent documentEvent) {
      if(documentListenerList != null) {
        for(int i=0, n=documentListenerList.size(); i<n; i++) {
          try {
            ((IDocumentListener)documentListenerList.get(i)).onInsertDone(documentEvent);
          }
          catch(java.lang.Exception exception) {
            //do not consume
          }
    ...
    public void onUnload(IDocumentEvent documentEvent) {
      if(documentListenerList != null) {
        for(int i=0, n=documentListenerList.size(); i<n; i++) {
          try {
            ((IDocumentListener)documentListenerList.get(i)).onUnload(documentEvent);
          }
          catch(java.lang.Exception exception) {
            //do not consume
          }
    ...
    public void disposing(IEvent event) {
      if(documentListenerList != null) {
        for(int i=0, n=documentListenerList.size(); i<n; i++) {
          try {
            ((IDocumentListener)documentListenerList.get(i)).disposing(event);
          }
          catch(java.lang.Exception exception) {
            //do not consume
          }
  ...
  public IFormService getFormService() {
    XDrawPageSupplier drawPageSupplier = ((XDrawPageSupplier) UnoRuntime.queryInterface(XDrawPageSupplier.class, xComponent));
  ...
  public void addDocumentModifyListener(IDocumentModifyListener documentModifyListener) {
    ...
    modifyListenerTable.put(documentModifyListener, documentListenerWrapper);
  }
  //----------------------------------------------------------------------------
  /**
  ...
  public void removeDocumentModifyListener(IDocumentModifyListener documentModifyListener) {
    if(modifyListenerTable != null) {
      if(modifyListenerTable.containsKey(documentModifyListener)) {
        DocumentModifyListenerWrapper documentModifyListenerWrapper = (DocumentModifyListenerWrapper)modifyListenerTable.get(documentModifyListener);
...
//    }
    /**
     * We do not use the XModifiable interface because it 
     * can cause a deadlock in Multi-Thread Enviroments. 
     */
    return isModified;
  }
  //----------------------------------------------------------------------------
  ...
  public void removeCloseListener(ICloseListener closeListener) {
    ...
    if(closeListeners.containsKey(closeListener)) {
      CloseListenerWrapper closeListenerWrapper = (CloseListenerWrapper)closeListeners.get(closeListener);
        ...
        if(xModel!=null) {        	
          ...
          com.sun.star.frame.XController xController =
            (com.sun.star.frame.XController)UnoRuntime.queryInterface(
              com.sun.star.frame.XController.class, xComponent);
  ...
  private void addModifyListener(XModifyListener xModifyListener) {
    XModifyBroadcaster xModifyBroadcaster = 
      (XModifyBroadcaster)UnoRuntime.queryInterface(XModifyBroadcaster.class, xComponent);
  ...
  private void addEventListener(XEventListener xEventListener) {
    XEventBroadcaster xEventBroadcaster = (XEventBroadcaster)UnoRuntime.queryInterface(XEventBroadcaster.class, xComponent);
  ...
  public void fireDocumentEvent(String documentEventName) {
    ...
    IDocumentEvent documentEvent = new DocumentEvent(
        new EventObject(getXComponent(), documentEventName));
    ...
    for (int i = 0, n = documentListenerList.size(); i < n; i++) {
      ...
      if(object instanceof IDocumentListener) {
        ...
        else if(documentEventName.equalsIgnoreCase(IDocument.EVENT_ON_MOUSE_OVER))
          documentListener.onMouseOver(documentEvent);
        else if(documentEventName.equalsIgnoreCase(IDocument.EVENT_ON_MOUSE_OUT))
          documentListener.onMouseOut(documentEvent);
        else if(documentEventName.equalsIgnoreCase(IDocument.EVENT_ON_FOCUS))
          documentListener.onFocus(documentEvent);
        else if(documentEventName.equalsIgnoreCase(IDocument.EVENT_ON_ALPHA_CHAR_INPUT))
