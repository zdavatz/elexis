  ...
  public XFrame getOfficeFrame(Container container) {
    if(officeConnection != null) {      
      try {
        ...
        OfficeWindow officeWindow = createLocalOfficeWindow(container);
        container.add(officeWindow.getAWTComponent());
        ...
        XWindow xWindow = (XWindow)UnoRuntime.queryInterface(XWindow.class, officeWindow.getUNOWindowPeer());
        object = getXMultiServiceFactory().createInstance("com.sun.star.frame.Task"); //$NON-NLS-1$
        if (object == null)
          object = getXMultiServiceFactory().createInstance("com.sun.star.frame.Frame"); //$NON-NLS-1$
        if(LOGGER.isLoggable(Level.FINEST))
        ...
        Object desktop = getXMultiServiceFactory().createInstance( "com.sun.star.frame.Desktop"); //$NON-NLS-1$
        com.sun.star.frame.XFrames xFrames = ((com.sun.star.frame.XFramesSupplier)UnoRuntime.queryInterface(com.sun.star.frame.XFramesSupplier.class, desktop ) ).getFrames();
    ...
    if(officeConnection != null) {      
      try {
        ...
        XToolkit xToolkit =(XToolkit)UnoRuntime.queryInterface(
            XToolkit.class,getXMultiServiceFactory().createInstance("com.sun.star.awt.Toolkit") ); 
