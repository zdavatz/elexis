...
public class TextDocument extends AbstractDocument implements ITextDocument {
   ...
   * @author Andreas Bröcker
   */
  public TextDocument(XTextDocument xTextDocument) throws IllegalArgumentException {
  ...
  public XMultiServiceFactory getMultiServiceFactory() throws Exception {
    XMultiServiceFactory multiServiceFactory = (XMultiServiceFactory) UnoRuntime.queryInterface (XMultiServiceFactory.class, xTextDocument);
  ...
  //----------------------------------------------------------------------------
	...
	public ISearchService getSearchService() {
		...
		return new SearchService(searchable);
	}
  //----------------------------------------------------------------------------
  /**
