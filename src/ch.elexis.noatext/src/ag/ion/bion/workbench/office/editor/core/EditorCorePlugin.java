...
/*
 * Last changes made by $Author: andreas $, $Date: 2006/10/04 12:38:13 $
 */
...
public class EditorCorePlugin extends Plugin {
  ...
  /** ID of the plugin. */
  public static final String PLUGIN_ID = "ch.elexis.noatext";
  ...
  public String getLibrariesLocation() {
    if(librariesLocation == null) {
      try {
        URL url = Platform.getBundle("ch.elexis.noatext").getEntry("/");
