...
public interface ILayoutManager {
  ...
  public static final String URL_PREFIX_TOOLBAR             = URL_PREFIX
                                                                + "/toolbar";

  /** Resource URL of the menubar. */
  public static final String URL_MENUBAR                    = URL_PREFIX
                                                                + "/menubar/menubar";
  /** Resource URL of the statusbar. */
  public static final String URL_STATUSBAR                  = URL_PREFIX
                                                                + "/statusbar/statusbar";
  /** Resource URL of the toolbar. */
  public static final String URL_TOOLBAR                    = URL_PREFIX_TOOLBAR
                                                                + "/toolbar";
  /** Resource URL of the toolbar alignmentbar. */
  public static final String URL_TOOLBAR_ALIGNMENTBAR       = URL_PREFIX_TOOLBAR
                                                                + "/alignmentbar";
  /** Resource URL of the toolbar arrowshapes. */
  public static final String URL_TOOLBAR_ARROWSHAPES        = URL_PREFIX_TOOLBAR
                                                                + "/arrowshapes";
  /** Resource URL of the toolbar basicshapes. */
  public static final String URL_TOOLBAR_BASICSHAPES        = URL_PREFIX_TOOLBAR
                                                                + "/basicshapes";
  /** Resource URL of the toolbar calloutshapes. */
  public static final String URL_TOOLBAR_CALLOUTSHAPES      = URL_PREFIX_TOOLBAR
                                                                + "/calloutshapes";
  /** Resource URL of the toolbar drawbar. */
  public static final String URL_TOOLBAR_DRAWBAR            = URL_PREFIX_TOOLBAR
                                                                + "/drawbar";
  /** Resource URL of the toolbar drawobjectbar. */
  public static final String URL_TOOLBAR_DRAWOBJECTBAR      = URL_PREFIX_TOOLBAR
                                                                + "/drawobjectbar";
  /** Resource URL of the toolbar extrusionobjectbar. */
  public static final String URL_TOOLBAR_EXTRUSIONOBJECTBAR = URL_PREFIX_TOOLBAR
                                                                + "/extrusionobjectbar";
  /** Resource URL of the toolbar fontworkobjectbar. */
  public static final String URL_TOOLBAR_FONTWORKOBJECTBAR  = URL_PREFIX_TOOLBAR
                                                                + "/fontworkobjectbar";
  /** Resource URL of the toolbar fontworkshapetypes. */
  public static final String URL_TOOLBAR_FONTWORKSHAPETYPES = URL_PREFIX_TOOLBAR
                                                                + "/fontworkshapetypes";
  /** Resource URL of the toolbar formatobjectbar. */
  public static final String URL_TOOLBAR_FORMATOBJECTBAR    = URL_PREFIX_TOOLBAR
                                                                + "/formatobjectbar";
  /** Resource URL of the toolbar formcontrols. */
  public static final String URL_TOOLBAR_FORMCONTROLS       = URL_PREFIX_TOOLBAR
                                                                + "/formcontrols";
  /** Resource URL of the toolbar formdesign. */
  public static final String URL_TOOLBAR_FORMDESIGN         = URL_PREFIX_TOOLBAR
                                                                + "/formdesign";
  /** Resource URL of the toolbar formsfilterbar. */
  public static final String URL_TOOLBAR_FORMFILTERBAR      = URL_PREFIX_TOOLBAR
                                                                + "/formsfilterbar";
  /** Resource URL of the toolbar formsnavigationbar. */
  public static final String URL_TOOLBAR_FORMSNAVIGATIONBAR = URL_PREFIX_TOOLBAR
                                                                + "/formsnavigationbar";
  /** Resource URL of the toolbar formsobjectbar. */
  public static final String URL_TOOLBAR_FORMSOBJECTBAR     = URL_PREFIX_TOOLBAR
                                                                + "/formsobjectbar";
  /** Resource URL of the toolbar formtextobjectbar. */
  public static final String URL_TOOLBAR_FORMSTEXTOBJECTBAR = URL_PREFIX_TOOLBAR
                                                                + "/formtextobjectbar";
  /** Resource URL of the toolbar fullscreenbar. */
  public static final String URL_TOOLBAR_FULLSCREENBAR      = URL_PREFIX_TOOLBAR
                                                                + "/fullscreenbar";
  /** Resource URL of the toolbar graphicobjectbar. */
  public static final String URL_TOOLBAR_GRAPHICOBJECTBAR   = URL_PREFIX_TOOLBAR
                                                                + "/graphicobjectbar";
  /** Resource URL of the toolbar insertbar. */
  public static final String URL_TOOLBAR_INSERTBAR          = URL_PREFIX_TOOLBAR
                                                                + "/insertbar";
  /** Resource URL of the toolbar insertcellsbar. */
  public static final String URL_TOOLBAR_INSERTCELLSBAR     = URL_PREFIX_TOOLBAR
                                                                + "/insertcellsbar";
  /** Resource URL of the toolbar insertobjectbar. */
  public static final String URL_TOOLBAR_INSERTOBJECTSBAR   = URL_PREFIX_TOOLBAR
                                                                + "/insertobjectbar";
  /** Resource URL of the toolbar mediaobjectbar. */
  public static final String URL_TOOLBAR_MEDIAOBJECTSBAR    = URL_PREFIX_TOOLBAR
                                                                + "/mediaobjectbar";
  /** Resource URL of the toolbar moreformcontrols. */
  public static final String URL_TOOLBAR_MOREFORMCONTROLS   = URL_PREFIX_TOOLBAR
                                                                + "/moreformcontrols";
  /** Resource URL of the toolbar previewbar. */
  public static final String URL_TOOLBAR_PREVIEWBAR         = URL_PREFIX_TOOLBAR
                                                                + "/previewbar";
  /** Resource URL of the toolbar standardbar. */
  public static final String URL_TOOLBAR_STANDARDBAR        = URL_PREFIX_TOOLBAR
                                                                + "/standardbar";
  /** Resource URL of the toolbar starshapes. */
  public static final String URL_TOOLBAR_STARSHAPES         = URL_PREFIX_TOOLBAR
                                                                + "/starshapes";
  /** Resource URL of the toolbar symbolshapes. */
  public static final String URL_TOOLBAR_SYMBOLSHAPES       = URL_PREFIX_TOOLBAR
                                                                + "/symbolshapes";
  /** Resource URL of the toolbar textobjectbar. */
  public static final String URL_TOOLBAR_TEXTOBJECTBAR      = URL_PREFIX_TOOLBAR
                                                                + "/textobjectbar";
  /** Resource URL of the toolbar tableobjectbar. */
  public static final String URL_TOOLBAR_TABLEOBJECTBAR     = URL_PREFIX_TOOLBAR
                                                                + "/tableobjectbar";
  /** Resource URL of the toolbar viewerbar. */
  public static final String URL_TOOLBAR_VIEWERBAR          = URL_PREFIX_TOOLBAR
                                                                + "/viewerbar";

  /** All resource URLs of all bars. */
  public static String[] ALL_BARS_URLS = new String[] {
    URL_MENUBAR,
    URL_STATUSBAR,
    URL_TOOLBAR,
