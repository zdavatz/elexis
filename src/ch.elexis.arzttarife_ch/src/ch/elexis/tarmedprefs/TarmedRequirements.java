...
public class TarmedRequirements {
	...
	public static final String INSURANCE =
		Messages.getString("TarmedRequirements.KostentraegerName"); //$NON-NLS-1$
	public static final String INSURANCE_NUMBER =
		Messages.getString("TarmedRequirements.InsuranceNumberName"); //$NON-NLS-1$
	public static final String CASE_NUMBER =
		Messages.getString("TarmedRequirements.CaseNumberName"); //$NON-NLS-1$
	public static final String INTERMEDIATE =
		Messages.getString("TarmedRequirements.IntermediateName"); //$NON-NLS-1$
	public static final String ACCIDENT_NUMBER =
		Messages.getString("TarmedRequirements.AccidentNumberName"); //$NON-NLS-1$
	...
	public static final String ACCIDENT_DATE =
		Messages.getString("TarmedRequirements.AccidentDate"); //$NON-NLS-1$
	...
	static {
		Xid.localRegisterXIDDomainIfNotExists(DOMAIN_KSK, Messages
			.getString("TarmedRequirements.kskName"), Xid.ASSIGNMENT_REGIONAL); //$NON-NLS-1$
		Xid.localRegisterXIDDomainIfNotExists(DOMAIN_NIF, Messages
			.getString("TarmedRequirements.NifName"), Xid.ASSIGNMENT_REGIONAL); //$NON-NLS-1$
		Xid
			.localRegisterXIDDomainIfNotExists(DOMAIN_RECIPIENT_EAN,
