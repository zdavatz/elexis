...
public class RFE extends PersistentObject {
	...
	private static final String createDB =
		"CREATE TABLE " + TABLENAME + " (" + "ID VARCHAR(25) primary key,"
			+ "deleted CHAR(1) default '0'," + "lastupdate bigint," + "type CHAR(2),"
			+ "konsID VARCHAR(25)" + ");" + "CREATE INDEX " + TABLENAME + "_idx ON " + TABLENAME
			+ " (konsID);" + "INSERT INTO " + TABLENAME + " (ID, konsID) VALUES ('VERSION','"
			+ Version + "');";
