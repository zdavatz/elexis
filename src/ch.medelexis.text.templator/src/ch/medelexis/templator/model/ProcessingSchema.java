...
public class ProcessingSchema extends Document {
	...
	public void setDirectOutput(boolean bDirect) {
		doc.getRootElement().setAttribute("directoutput",
				Boolean.toString(bDirect));
	}
	...
	public static ProcessingSchema load(InputStream is) throws JDOMException,
			IOException {
	...
	public static IProcessor[] getProcessors() {
		if (processors == null) {
			...
			IExtensionPoint exp = exr
					.getExtensionPoint("ch.medelexis.text.templator.Textprocessor");
			if (exp != null) {
