	...
	public ProcessingSchemaDisplay(Composite parent, ICallback handler) {
		...
		bChoose.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				fd.setFilterPath(Hub.localCfg.get(
						Preferences.PREF_TEMPLATEBASE,
	...
	private void makeActions() {
		printAction = new Action("Ausgeben") {
			...
			public void run() {
				...
				if (pr == null) {
					SWTHelper
							.alert("Es ist kein Prozessor definiert",
		...
		addAction = new Action("Variable hinzufügen") {
			...
			public void run() {
				InputDialog id = new InputDialog(getShell(),
						"Neues Prozessorfeld",
						"Geben Sie bitte einen Namen für das Feld ein",
						"Textfeld", new IInputValidator() {
