...
public class StringTool {
	...
	public static String unique(final String salt){
		...
		return new StringBuilder().append(start).append(Long.toHexString(t4)).append(
			Long.toHexString((long) Math.random() * 1000)).append(sequence).toString();
	}
	...
	private static final char[] salties =
		{
			'q', 'w', 'e', 'r', 't', 'z', 'u', 'o', 'i', 'p', 'a', 's', 'd', 'f', 'g', 'h', 'j',
			'k', 'l', 'y', 'x', 'c', 'v', 'b', 'n', 'm', 'Q', 'A', 'Y', 'W', 'E', 'D', 'C', 'R',
			'F', 'V', 'T', 'G', 'B', 'Z', 'H', 'N', 'U', 'J', 'M', 'I', 'K', 'O', 'L', 'P'
		};
}