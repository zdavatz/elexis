...
/**
 * Interface which allows customization of the behavior of the <code>Database<</code> import/copy
 * methods.
 * 
...
public interface ImportFilter {
	 ...
	 * 
	 * @param destColumns
	 *            the columns as determined by the import code, may be directly modified and
	 *            returned
	 * @param srcColumns
	 *            the sql metadata, only available if importing from a JDBC source
