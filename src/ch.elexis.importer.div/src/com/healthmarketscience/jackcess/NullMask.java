...
/**
 * Bitmask that indicates whether or not each column in a row is null. Also holds values of boolean
 * columns.
 * 
 * @author Tim McCune
 */
public class NullMask {
	...
	/**
	 * @param columnCount
	 *            Number of columns in the row that this mask will be used for
	 */
	...
	/**
	 * @param column
	 *            column to test for {@code null}
	 * @return Whether or not the value for that column is null. For boolean columns, returns the
	 *         actual value of the column (where non-{@code null} == {@code true})
	 */
	...
	/**
	 * Indicate that the column with the given number is not {@code null} (or a boolean value is
	 * {@code true}).
	 * 
	 * @param column
	 *            column to be marked non-{@code null}
	 */
