...
public abstract class TempBufferHolder {
	...
	public enum Type {
		...
		HARD,
		/**
		 * a soft reference is maintained to the created buffer (may be garbage collected if memory
		 * gets tight)
		 */
		SOFT,
		/**
	...
	/**
	 * @return the modification count of the current buffer (this count is changed every time the
	 ...
	 * 
	 * @param type
	 *            the type of reference desired for any created buffer
	 * @param autoRewind
	 *            whether or not every get automatically rewinds the buffer
	 */
	 ...
	 *            whether or not every get automatically rewinds the buffer
	 * @param order
	 *            byte order for all allocated buffers
	 */
	...
	/**
	 * Returns a ByteBuffer of at least the defined page size, with the limit set to the page size,
	 * and the predefined byteOrder. Will be rewound iff autoRewind is enabled for this buffer.
	 */
	...
	/**
	 * Returns a ByteBuffer of at least the given size, with the limit set to the given size, and
	 * the predefined byteOrder. Will be rewound iff autoRewind is enabled for this buffer.
	 */
