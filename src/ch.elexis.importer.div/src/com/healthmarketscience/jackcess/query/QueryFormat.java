...
public class QueryFormat {
	...
	public static final Map<Short, String> PARAM_TYPE_MAP = new HashMap<Short, String>();
	static {
	...
	public static final Map<Short, String> JOIN_TYPE_MAP = new HashMap<Short, String>();
	static {
