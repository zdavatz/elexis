...
public class RowId implements Comparable<RowId> {
	...
	public static final RowId FIRST_ROW_ID = new RowId(FIRST_PAGE_NUMBER, INVALID_ROW_NUMBER);
	
	/** special rowId which will sort after any other valid rowId */
	public static final RowId LAST_ROW_ID = new RowId(LAST_PAGE_NUMBER, INVALID_ROW_NUMBER);
	...
	public RowId(int pageNumber, int rowNumber){
		...
		_type =
			((_pageNumber == FIRST_PAGE_NUMBER) ? Type.ALWAYS_FIRST
					: ((_pageNumber == LAST_PAGE_NUMBER) ? Type.ALWAYS_LAST : Type.NORMAL));
	}
	...
	/**
	 * Returns {@code true} if this rowId potentially represents an actual row of data, {@code
	 * false} otherwise.
	 */
	...
	public int compareTo(RowId other){
		return new CompareToBuilder().append(getType(), other.getType()).append(getPageNumber(),
			other.getPageNumber()).append(getRowNumber(), other.getRowNumber()).toComparison();
	}
	...
	public boolean equals(Object o){
		return ((this == o) || ((o != null) && (getClass() == o.getClass())
			&& (getPageNumber() == ((RowId) o).getPageNumber()) && (getRowNumber() == ((RowId) o)
			.getRowNumber())));
	}
