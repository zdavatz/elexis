...
public final class ByteUtil {
	 ...
	 * 
	 * @param buffer
	 *            buffer into which to insert the int
	 * @param val
	 *            Int to convert
	 */
	 ...
	 *            Int to convert
	 * @param order
	 *            the order to insert the bytes of the int
	 */
	 ...
	 *            Int to convert
	 * @param offset
	 *            offset at which to insert the int
	 * @param order
	 *            the order to insert the bytes of the int
	 */
	 ...
	 * @param order
	 *            the order of the bytes of the int
	 * @return an int from the current position in the given buffer, read using the given ByteOrder
	 */
	 ...
	 * @param order
	 *            the order of the bytes of the int
	 * @return an int from the given position in the given buffer, read using the given ByteOrder
	 */
	...
	/**
	 * Writes a sequence of hexidecimal values into the given buffer, where every two characters
	 * represent one byte value.
	 */
	 ...
	 */
	public static void toHexFile(String fileName, ByteBuffer buffer, int offset, int size)
		throws IOException{
	 ...
	 * 
	 * @param bytes
	 *            buffer containing bytes to swap
	 * @param offset
	 *            offset of the first byte of the bytes to swap
	 */
